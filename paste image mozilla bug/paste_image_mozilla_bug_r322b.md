...
The image is not pasted in the animation editor if I use Mozilla.
...
2. Create a sprite.
3. Copy to clipboard an image from a third-party image editing tool.
4. Paste the image in the sprite animation editor.
