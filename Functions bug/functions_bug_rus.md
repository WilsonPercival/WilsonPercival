...
(если скопировать группу, то в новой группе функция поменяет название, но вызов всё ещё будет указывать на функцию из первой группы.)
...
Storage usage (approx): 457 mb (0.8%)
