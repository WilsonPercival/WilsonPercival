...
`[opacity=0][background=#f007]Text[/background][/opacity]`

The problem is that the background remains opaque. Note that if you do the same with a `Text` object, the background will be transparent.

## Attach a .c3p

[sprite_font_bbcode_opacity_background_bug_r115b.zip](https://github.com/user-attachments/files/15744245/sprite_font_bbcode_opacity_background_bug_r115b.zip)
...
<img width="326" alt="observed" src="https://github.com/WilsonPercival/WilsonPercival/assets/91274932/893b5e5e-89a5-4281-9054-15afe011239b">
