...
There is a local variable in a group. Every tick we assign 13 to this variable. Then we call the function "Start". From this function we call the function "End" in which we print the value of said variable to console. But we see the default value (0).
...
If you call "End" instead of "Start" then you'll see the correct value (13).
