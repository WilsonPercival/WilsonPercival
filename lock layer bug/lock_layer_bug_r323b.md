...
The text is not created on the layer that was selected.

## Attach a .c3p

[lock_layer_bug_r323b.zip](https://github.com/WilsonPercival/WilsonPercival/files/10298678/lock_layer_bug_r323b.zip)

## Steps to reproduce

1. Create a new project.
2. Create a new layer.
3. Lock the new layer.
4. Click on the old layer.
5. Click on the new layer.
6. Create text.
7. Unlock the new layer.
8. Create text.

## Observed result

https://user-images.githubusercontent.com/91274932/209438493-4f68a526-1235-4c7e-8800-ad0b57c9033f.mp4

## Expected result

The text is created on the same layer that was selected.
...
Storage usage (approx): 50 mb (0.5%)
