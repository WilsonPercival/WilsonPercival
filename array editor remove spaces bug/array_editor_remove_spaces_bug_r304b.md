...
When I paste text from notepad into the array editor and open the cell, there is only one space left.

## Attach a .c3p

[array_editor_remove_spaces_bug_r304b.zip](https://github.com/WilsonPercival/WilsonPercival/files/9277486/array_editor_remove_spaces_bug_r304b.zip)

## Steps to reproduce

1. Create a new project.
2. Create an `Array` in the `Files` folder.
3. Write in a notepad

```
1        9
```
4. Paste the content into the cell.
5. Open the cell.

## Observed result

![bug](https://user-images.githubusercontent.com/91274932/183309808-73a092e5-5aae-49e6-ac08-b6317465daf8.gif)
...
Storage usage (approx): 26 mb (0.3%)
