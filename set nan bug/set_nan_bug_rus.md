...
Невозможно присвоить NaN свойству X спрайта через JS ни через NaN ни через 0 / 0.
...
Чтобы это работало одинаково, что я делаю через ивенты или через JS.

## More details

Я не могу присвоить NaN через JS, но спокойно могу присвоить через ивенты. Scroll я могу установить NaN что через ивенты, что через JS.
...
Storage usage (approx): 546 mb (0.9%)
