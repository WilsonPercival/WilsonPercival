...
[timeline_animations_bug_r337b.zip](https://github.com/WilsonPercival/WilsonPercival/files/14369010/timeline_animations_bug_r337b.zip)
...
7. Close `Timeline Bar`.
8. Click `Undo` 3 times.
9. Press `Redo` 3 times.
10. In the left ear, switch Initial animation to `Animation 2`.
11. In the left ear, switch Initial animation to `Animation 1`. Note that the sprite shows `Animation 1` all the time.

## Observed result

https://github.com/WilsonPercival/WilsonPercival/assets/91274932/7efb1b3f-e993-40d8-8ef3-8084f3a5bef0
...
**First affected release:** It's hard to say because there were other bugs in previous versions that prevent this one from being reproduced.
