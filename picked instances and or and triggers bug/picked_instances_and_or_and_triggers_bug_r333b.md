...
2. Press 1. Note that the sprite has turned black.
3. Restart the project.
4. Press 2. Notice that nothing happened.

## Observed result

In one case, the sprite performs actions, in the other it does not.

## Expected result

In both cases, it should work the same way. Either always perform actions or always do not perform actions.
