...
2. Создаём спрайт.
3. Рисуем небольшой кружок с центра.
4. Дублируем фрейм.
5. Нажимаем "Новый файл".
6. Рисуем линию.
7. Жмём "Обрезать".
8. Переключаемся на первый кадр.
9. Жмём "Обрезать".
10. Переключаемся на второй кадр.
11. Видим баг.
12. Не наводя курсор на редактируемую область (иначе баг исчезнет) переключаемся на первый кадр.
13. Закрываем редактор анимаций.
14. Открываем редактор анимаций.

## Observed result

На втором кадре отпечаток первого кадра.
