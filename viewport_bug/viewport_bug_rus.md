...
Сначала я меняю значение прокрутки макета. После этого runtime.layout.getLayer(0).getViewport().right возвращает значение, которое отстаёт.
...
**First affected release:** broke in r276-2s, r284b
...
Storage usage (approx): 564 mb (0.9%)
