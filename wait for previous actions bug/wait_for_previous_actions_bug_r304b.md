...
The `Wait for previous actions` action on certain triggers waits for the next tick, but not on others.

## Attach a .c3p

[wait_for_previous_actions_bug_r304b.zip](https://github.com/WilsonPercival/WilsonPercival/files/9235896/wait_for_previous_actions_bug_r304b.zip)

## Steps to reproduce

1. Open and run the project.2
2. Open the console.
3. Press buttons 1, 2, 3, 4, 5, 6.
4. Push the two sprites together.
...
Storage usage (approx): 270 mb (0.5%)
