...
`[background=#f007]Text[/background]`

The problem is that the background remains opaque. Note that if you do the same with a `Text` object, the background will be semi-transparent.

## Attach a .c3p

[sprite_font_bbcode_background_color_opacity_bug_r115b.zip](https://github.com/WilsonPercival/WilsonPercival/files/15247040/sprite_font_bbcode_background_color_opacity_bug_r115b.zip)
...
<img width="245" alt="observed" src="https://github.com/WilsonPercival/WilsonPercival/assets/91274932/e4a16cc6-0dc0-43e1-9e20-85d9e921cc47">
