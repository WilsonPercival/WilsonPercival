...
3. Click the `Toggle device toolbar` button to open the mobile view.
4. Click `Dimensions` and select `IPhone 14 Pro Max` 430x932. Please don't ignore this step because it is very important.
5. Drag the sprite until it touches the bottom edge of the screen.

## Observed result

https://github.com/WilsonPercival/WilsonPercival/assets/91274932/f8f8c31f-418c-4900-8b35-fc545fc5c340
