...
[user_media_size_bug_r276_2s.zip](https://github.com/WilsonPercival/WilsonPercival/files/7907899/user_media_size_bug_r276_2s.zip)
...
Размеры камеры были 480x640 при портретной ориентации, но когда я изменил на ландшафтную ориентацию - размеры остались 640x480 пока я не запросил ещё раз камеру.
...
Storage usage (approx): 403 mb (0.7%)
